...
public class PeliculasController {
	...
	@PostMapping("/guardar")
	public String guarda(Pelicula pelicula, @RequestParam("archivoImagen") MultipartFile multiPart) {
		if (!multiPart.isEmpty()) {
			String ruta = "c:/peliculas/img-peliculas/"; // Windows
			String archivoImagen = Utileria.guardarArchivo(multiPart, ruta);
			if (archivoImagen != null){ 
			pelicula.setImagen(archivoImagen);
			}
            }
